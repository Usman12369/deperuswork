...
DATA_DIR = os.getenv("BOT_DATA_DIR", "/app/data/bot2")
...
def init_db():
    ...
    logger.info("Bot2 DB ready: %s", DB_PATH)
        ...
        if data == "menu:profile":
            ...
            send_message(
                ...
                (
                    ...
                    f"<i>Отзыв полностью анонимен. Только студент увидит сам отзыв, но не увидит твое имя.</i>\n\n"
